...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="carousel slide" id="carousel-278745">
					<ol class="carousel-indicators">
						<li data-slide-to="0" data-target="#carousel-278745" class="active"></li>
						<li data-slide-to="1" data-target="#carousel-278745"></li>
						<li data-slide-to="2" data-target="#carousel-278745"></li>
					</ol>
					...
					<a class="carousel-control-prev" href="#carousel-278745" data-slide="prev"><span class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span></a>
					<a class="carousel-control-next" href="#carousel-278745" data-slide="next"><span class="carousel-control-next-icon"></span> <span class="sr-only">Next</span></a>
				</div>
			</div>
		</div>
		<div class="row">
